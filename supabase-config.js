...
async function bootAVersionAfterR50() {
  ...
  await import('./seedance/r54-paid-safety.js?v=20260827-generation-button-fix-v2')
    .then(({ initPaidSafetyR54 }) => initPaidSafetyR54())
    .then(() => import('./seedance/r54-deliverables.js?v=20260827-generation-button-fix-v2'))
